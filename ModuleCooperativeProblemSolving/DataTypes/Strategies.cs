...
namespace Modules.ModuleCooperativeProblemSolving
{
    public class Strategies
    {
        ...
        private void UpdateWins()
        {
            ...
            module.wins.Columns[0].HeaderText = Properties.Resources.Choice;
            for (int i = 0; i < strategyList.Count; i++)
            {
                module.wins.Columns[i + 1].HeaderText = Properties.Resources.Win + " " + (i + 1);
        ...
        private void UpdateView()
        {
            ...
            while (labels.Count < N)
            {
                Label lbl = new Label();
                lbl.AutoSize = true;
                lbl.Text = Properties.Resources.Gamer + " " + (labels.Count + 1);
