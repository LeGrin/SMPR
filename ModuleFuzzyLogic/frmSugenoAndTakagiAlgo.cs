...
{
    public partial class frmSugenoAndTakagiAlgo : Form
    {
        public frmSugenoAndTakagiAlgo()
        {
            InitializeComponent();
        ...
        private void onCompute(object sender, EventArgs e) {
            ...
            do
            {
                dialRes = prompt.ShowDialog();
                if (dialRes != System.Windows.Forms.DialogResult.OK) return;
            } while (!Double.TryParse(prompt.Value, out b2));

            Methods.SugenoAndTakagiAlgo algo = new Methods.SugenoAndTakagiAlgo();
            
            algo.GetAnswer(A1, A2, B1, B2, C1, C2, x0, y0, a1, a2, b1, b2);  
